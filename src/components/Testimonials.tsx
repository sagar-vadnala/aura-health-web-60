      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white rounded-2xl p-12 shadow-sm hover:shadow-md transition-shadow duration-300 relative px-[12px] py-[12px]">
              ...
              <div className="border-t pt-4 py-0">
