      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mb-8 leading-relaxed text-left font-normal text-black text-xl">Drowning in documentation?
Supercharge your clinical workflows with reliable AI built for healthcare. From AI scribing to smart scheduling — Hikigai helps you save time, reduce burnout & improve patient outcomes.</p>
          ...
          <div className="relative">
            {/* Desktop Screen - Fixed positioning */}
            <div className="relative bg-gray-800 rounded-2xl p-1 shadow-2xl px-[30px] py-[20px]">
              <div className="bg-white rounded-xl overflow-hidden w-[520px] h-[380px]">
            ...
            {/* iPhone Screen - Positioned to the right */}
            <div className="absolute -bottom-8 -right-12 bg-black rounded-3xl p-1 shadow-xl w-[120px] h-[240px]">
