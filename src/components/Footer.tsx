...
const Footer = () => {
  return (
    <footer className="text-white py-[20px] bg-blue-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li><Link to="/ai-products" className="hover:text-purple-400 transition-colors duration-200">Smart App</Link></li>
