...
const PlatformHighlights = () => {
  const highlights = [
    ...
    },
    {
      ...
      description: "Seamless integration with external Electronic Health Record systems"
    },
    {
      icon: Shield,
          ...
          <div>
            <div className="space-y-4">
              {highlights.map((highlight, index) => (
                <div key={index} className="bg-gradient-to-br from-gray-50 to-purple-50 rounded-2xl p-6 hover:shadow-lg transition-shadow duration-300 group py-[5px] px-[5px]">
